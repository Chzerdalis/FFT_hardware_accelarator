...
//    (* dont_touch = "yes" *) wire signed [PROD-1:0] m0r = mul_m0r_reg_1 - mul_m0r_reg_2;
//    (* dont_touch = "yes" *) wire signed [PROD-1:0] m0i = mul_m0i_reg_1 + mul_m0i_reg_2;

//    (* dont_touch = "yes" *) wire signed [PROD-1:0] m1r = mul_m1r_reg_1 - mul_m1r_reg_2;
//    (* dont_touch = "yes" *) wire signed [PROD-1:0] m1i = mul_m1i_reg_1 + mul_m1i_reg_2;

//    (* dont_touch = "yes" *) wire signed [PROD-1:0] m2r = mul_m2r_reg_1 - mul_m2r_reg_2;
//    (* dont_touch = "yes" *) wire signed [PROD-1:0] m2i = mul_m2i_reg_1 + mul_m2i_reg_2;

...
//     assign twiddle_index_0 = (STAGE_NUM == 1) ? 3'b0 : (butterfly_op_counter << shift_value);
//     assign twiddle_index_1 = (STAGE_NUM == 1) ? 3'b0 : (butterfly_op_counter << (shift_value + 1));
//     assign twiddle_index_2 = (STAGE_NUM == 1) ? 3'b0 : ((butterfly_op_counter << (shift_value + 1)) + (butterfly_op_counter << shift_value));
//     //assign twiddle_index_2 = (STAGE_NUM == 1) ? 3'b0 : ((butterfly_op_counter << 1)) << shift_value;

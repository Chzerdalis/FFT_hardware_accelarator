...
module SdfUnit4_fast #(
    ...
    wire [KEY_WIDTH - 1:0] w0re, w0i, w1re, w1i, w2re, w2i;
    ...
    (* ram_style = "distributed" *) reg [KEY_WIDTH - 1:0] w_real_1 [0:twiddle_array_size-1];
    (* ram_style = "distributed" *) reg [KEY_WIDTH - 1:0] w_imag_1 [0:twiddle_array_size-1];
    (* ram_style = "distributed" *) reg [KEY_WIDTH - 1:0] w_real_2 [0:twiddle_array_size-1];
    (* ram_style = "distributed" *) reg [KEY_WIDTH - 1:0] w_imag_2 [0:twiddle_array_size-1];
    (* ram_style = "distributed" *) reg [KEY_WIDTH - 1:0] w_real_3 [0:twiddle_array_size-1];
    (* ram_style = "distributed" *) reg [KEY_WIDTH - 1:0] w_imag_3 [0:twiddle_array_size-1];

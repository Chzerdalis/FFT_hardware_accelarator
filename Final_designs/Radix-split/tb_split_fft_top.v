...
module tb_split_fft_top();
    ...
    parameter SimpleMult = 0;            // Set to 1 to enable simple multiplication
    parameter Fast_DSP = 0;              // Set to 1 to enable fast DSP
    parameter carry_save = 0;            // Set to 1 to enable carry-save addition
